    ...
    return (
        <section>
            ...
            <div className="container bg-blue rounded-xl py-12 px-10 mt-14">
                ...
                <h2 className="text-white text-center mx-auto mt-4 lg:mt-7 sm:w-4/6">
                    Crafted Aluminium Systems, Designed to Endure
                </h2>
                <p className='text-white mt-2 text-center'>Explore IDEL’s advanced lift & slide solutions built for seamless living.</p>
